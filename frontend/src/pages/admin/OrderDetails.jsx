...
function addressLine(order) {
  ...
  if (!a) return '';
  return `${a.address || ''}, ${a.city || ''}, ${a.state || ''} ${a.pincode || ''}`.replace(/,\s*,/g, ',').trim();
}
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1440px] mx-auto">
        ...
        {/* Orders — mobile card layout (below md) */}
        <div className="md:hidden flex flex-col gap-4">
          ...
          {!loading && error && (
            <p className="py-12 text-center text-sm text-[#A32D2D]">
              {error}
            </p>
          )}
          ...
          {!loading &&
            ...
            paginatedOrders.map((o) => {
              ...
              return (
                <div
                  key={o._id}
                  className="border border-[#CFC4C5] bg-white p-4 flex flex-col gap-4"
                >
                  {/* Product row */}
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-14 h-[72px] overflow-hidden flex-shrink-0 bg-[#EEEEEE]">
                      {productImage ? (
                        <img
                          src={productImage}
                          alt={productName}
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[10px] uppercase text-[#5E5E5E] mt-1 truncate">
                        {sku}
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-3 text-sm">
                    <div>
                      <p className="text-[10px] uppercase tracking-[0.1em] text-[#5E5E5E]">
                        Qty
                      </p>
                      <p className="text-black mt-0.5">{totalQty}</p>
                    </div>
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="text-black mt-0.5">{customerName(o)}</p>
                      <p className="text-[10px] uppercase text-[#5E5E5E] mt-0.5 break-all">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="text-[#5E5E5E] mt-0.5 leading-relaxed">
                        {addressLine(o)}
                      </p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="self-start inline-flex items-center gap-1 text-[11px] uppercase tracking-wide text-[#5E5E5E] hover:text-black transition-colors duration-200"
        ...
        {/* Orders Table — desktop/tablet (md and up) */}
        <div className="hidden md:block w-full overflow-x-auto">
          <table className="w-full border-collapse min-w-[1000px] table-fixed">
            <colgroup>
              <col className="w-[28%]" /> {/* Product */}
              <col className="w-[7%]" />  {/* Qty */}
              <col className="w-[16%]" /> {/* Customer */}
              <col className="w-[22%]" /> {/* Shipping Address */}
              <col className="w-[12%]" /> {/* Order Date */}
                ...
                paginatedOrders.map((o) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Shipping Address */}
                      <td className="py-6 px-4 text-sm leading-relaxed text-[#5E5E5E] truncate">
                        {addressLine(o)}
                      </td>
