...
//                   onChange={formik.handleChange}
//                   onBlur={formik.handleBlur}
//                   className="w-full border-0 border-b border-[rgba(93,94,99,0.30)] bg-transparent py-3 pr-12 text-[16px] font-normal text-[#1A1C1C] outline-none transition-colors duration-200 placeholder:text-[#C4C7C7] focus:border-black"
//                   style={{ fontFamily: 'Inter, sans-serif' }}
//                 />
...
//                     setShowPassword((s) => !s)
//                   }
//                   className="absolute right-0 text-[10px] font-medium uppercase tracking-[0.05em] text-[#5D5E63] hover:text-black whitespace-nowrap"
//                   style={{ fontFamily: 'Inter, sans-serif' }}
//                   tabIndex={-1}
//                 >
...
//                   <p
//                     className="mt-1 text-[10px] text-red-600 break-words"
//                     style={{ fontFamily: 'Inter, sans-serif' }}
//                   >
//                     {formik.errors.password}
//                   </p>
...
//             {authError && (
//               <p
//                 className="-mt-2 sm:-mt-4 text-[10px] text-red-600 break-words"
//                 style={{ fontFamily: 'Inter, sans-serif' }}
//               >
//                 {authError}
//               </p>
...
//               className="self-center text-[10px] font-medium text-[#5D5E63] underline decoration-1 underline-offset-4 hover:text-black text-center"
//               style={{ fontFamily: 'Inter, sans-serif' }}
//             >
...
export default function AdminLogin() {
  ...
  // Ref to the reCAPTCHA widget so we can force a genuine reset (not just
  // clearing our own React state) whenever a login attempt fails. reCAPTCHA
  // tokens are single-use and short-lived — without calling .reset() here,
  // the widget keeps showing a "checked" state after a failed attempt even
  // though it shouldn't be trusted for a second attempt.
          ...
          >
            ...
            <div className="relative flex flex-col">
              ...
              <div className="relative flex items-center">
                ...
                {/* Eye icon — absolutely positioned and vertically centered
                    against the input itself, so it stays in a fixed spot
                    regardless of label/error text length or input state. */}
                <button
                  type="button"
                  onClick={() => setShowPassword((s) => !s)}
                  className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center justify-center text-[#5D5E63] hover:text-black transition-colors"
                  tabIndex={-1}
            ...
            <div>
              ...
              {formik.touched.privacyConsent &&
                formik.errors.privacyConsent && (
                  <p
                    className="mt-1 text-[10px] text-red-600 ml-6"
                    style={{ fontFamily: 'Inter, sans-serif' }}
                  >
                    {formik.errors.privacyConsent}
                  </p>
