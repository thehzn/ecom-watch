...
export default function AdminLogin() {
  ...
  />
        ...
        <div className="w-full border border-[rgba(93,94,99,0.10)] bg-white p-6 sm:p-8 shadow-sm">
          <form onSubmit={formik.handleSubmit} className="flex flex-col gap-6 sm:gap-8" noValidate>
            {/* Email Field */}
            <div className="relative flex flex-col">
              <label
                htmlFor="email"
            ...
            <div className="relative flex flex-col">
              ...
              {formik.touched.password && formik.errors.password && (
                <p className="mt-1 text-[10px] text-red-600 break-words" style={{ fontFamily: 'Inter, sans-serif' }}>
                  {formik.errors.password}
                </p>
              )}
            </div>
            ...
            {authError && (
              <p className="-mt-2 sm:-mt-4 text-[10px] text-red-600 break-words" style={{ fontFamily: 'Inter, sans-serif' }}>
                {authError}
              </p>
            )}
