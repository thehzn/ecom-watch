...
export default function EditProduct() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      try {
        ...
        toast.error(err.message || 'Failed to load timepiece details');
      } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    const loadingToast = toast.loading('Updating timepiece specifications...');
    try {
      ...
      toast.dismiss(loadingToast);
      setError(err.message);
      toast.error(err.message || 'Failed to update timepiece');
    } finally {
      setSubmitting(false);
    }
  };
