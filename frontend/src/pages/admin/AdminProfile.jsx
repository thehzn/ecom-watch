        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 pb-10 sm:pb-12 lg:pb-16 border-b border-[#CFC4C5] mb-10 sm:mb-12 lg:mb-16">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
              <div>
                <p className="text-[10px] uppercase text-[#5E5E5E] mb-2">Name</p>
                <p className="text-sm pb-2 border-b border-[#CFC4C5] break-words">{PROFILE.name}</p>
              </div>
              <div>
                <p className="text-[10px] uppercase text-[#5E5E5E] mb-2">Email</p>
                <p className="text-sm pb-2 border-b border-[#CFC4C5] break-words">{user?.email}</p>
              </div>
            </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 pb-10 sm:pb-12 lg:pb-16 border-b border-[#CFC4C5] mb-10 sm:mb-12 lg:mb-16">
          ...
          <div className="lg:col-span-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
              <div>
                <p className="text-[10px] uppercase text-[#5E5E5E] mb-2">Company Name</p>
                <p className="text-sm pb-2 border-b border-[#CFC4C5] break-words">{COMPANY.name}</p>
              </div>
              <div>
                <p className="text-[10px] uppercase text-[#5E5E5E] mb-2">Headquarters</p>
                <p className="text-sm pb-2 border-b border-[#CFC4C5] break-words">{COMPANY.headquarters}</p>
              </div>
            </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-8">
            {resetSuccess ? (
              ...
              <>
                {/* Email + Request OTP */}
                <form onSubmit={handleRequestOtp} className="flex flex-col sm:flex-row sm:items-end gap-4 mb-6">
