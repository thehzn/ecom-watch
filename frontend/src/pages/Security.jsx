        ...
        <div className="w-full max-w-[460px] bg-[#0E1015]/90 border border-white/15 backdrop-blur-2xl rounded-3xl p-8 sm:p-12 shadow-2xl">
          ...
          {successMessage ? (
            ...
            >
                  ...
                  {!otpSent ? (
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="p-4 bg-[#141720] border border-white/10 rounded-2xl">
                        ...
                        <p className="text-xs text-gray-400 mt-2 leading-relaxed">
                          ...
                          registered email address before
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <input
                        ...
                        className="w-full bg-[#141720] border border-white/15 focus:border-white text-white text-sm rounded-xl px-4 py-3.5 outline-none tracking-[0.3em]"
                      />
              ...
              <Link
                to="/myaccount"
                className="inline-flex items-center justify-center gap-1.5 text-xs uppercase tracking-wider font-semibold text-gray-300 hover:text-white transition-colors w-full"
              >
                <span>
                  Return to Dashboard
                </span>
