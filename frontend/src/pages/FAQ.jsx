...
export default function FAQ() {
  ...
  return (
    <article className="w-full bg-[#08090C] text-white min-h-screen flex flex-col font-['Plus_Jakarta_Sans'] selection:bg-white selection:text-black relative overflow-hidden select-text">
      ...
      {/* FAQS SECTIONS RENDERING */}
      {filteredFaqs.length === 0 ? (
        <section className="py-20 text-center w-full max-w-[800px] mx-auto px-6 relative" aria-label="No Search Results">
          <SearchX className="w-12 h-12 text-gray-600 mb-4 mx-auto" aria-hidden="true" />
          <h2 className="text-xl text-white font-bold mb-2">No FAQs Found</h2>
