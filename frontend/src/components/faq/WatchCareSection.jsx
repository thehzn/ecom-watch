...
export default function WatchCareSection({ id, items }) {
  ...
  return (
    <section id={id} className="w-full py-10 md:py-16 scroll-mt-24 relative" aria-labelledby={`${id}-title`}>
      <div className="max-w-[800px] mx-auto px-6 md:px-8">
        <h2
          id={`${id}-title`}
          className="text-2xl font-bold text-white border-b border-white/10 pb-4 mb-8"
        >
          Watch Care
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="bg-[#0E1015] border border-white/10 rounded-2xl p-8 flex flex-col items-start">
            <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center mb-4">
              <Droplet size={18} className="text-white" aria-hidden="true" />
            </div>
            <h3 className="text-lg font-semibold text-white mb-3">Water Resistance</h3>
          ...
          <div className="bg-[#0E1015] border border-white/10 rounded-2xl p-8 flex flex-col items-start">
            <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center mb-4">
              <Wrench size={18} className="text-white" aria-hidden="true" />
            </div>
            <h3 className="text-lg font-semibold text-white mb-3">Servicing</h3>
            <p className="text-sm leading-6 text-gray-400">
              Scheduled professional servicing helps preserve the movement's integrity and long-term functional beauty. We suggest a periodic review every three to five years.
            </p>
          </div>
